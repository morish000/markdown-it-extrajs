var x=Object.create;var n=Object.defineProperty;var C=Object.getOwnPropertyDescriptor;var b=Object.getOwnPropertyNames;var I=Object.getPrototypeOf,M=Object.prototype.hasOwnProperty;var P=(t,e)=>{for(var r in e)n(t,r,{get:e[r],enumerable:!0})},f=(t,e,r,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let o of b(e))!M.call(t,o)&&o!==r&&n(t,o,{get:()=>e[o],enumerable:!(s=C(e,o))||s.enumerable});return t};var d=(t,e,r)=>(r=t!=null?x(I(t)):{},f(e||!t||!t.__esModule?n(r,"default",{value:t,enumerable:!0}):r,t)),$=t=>f(n({},"__esModule",{value:!0}),t);var E={};P(E,{createScriptTag:()=>p,createTemplateTag:()=>a,default:()=>k,initAll:()=>l});module.exports=$(E);var w=d(require("markdown-it-front-matter")),y=d(require("gray-matter"));var A=(t="https://esm.sh/mermaid")=>`export default async () => {
    const mermaid = await import("${t}");
    mermaid.default.init();
};`,u=A;var U=(t="https://esm.sh/@fortawesome")=>`const extractIcons = (iconSet) => {
...
};`,S=U;var v=(t="https://esm.sh/@unocss",e="https://esm.sh/",r={})=>{let s={...r};return s.presetIcons&&(s.presetIcons.cdn=e),`
...
`},g=v;var l=t=>(t.useMermaid||t.useFontAwesome||t.useUnoCSS)&&t.outputScriptTag?`
export default async () => {
  const tasks = [];
${t.useMermaid?`
...
<\/script>`:"";var T={discardFrontMatter:!0,useMermaid:!1,mermaidUrl:"https://esm.sh/mermaid",useFontAwesome:!1,fontAwesomeUrl:"https://esm.sh/@fortawesome",useUnoCSS:!1,unoCSSUrl:"https://esm.sh/@unocss",unoCSSPresetIconCDN:"https://esm.sh/",outputScriptTag:!0};function F(t,e){e.discardFrontMatter&&t.use(w.default,s=>{}),t.core.ruler.push("front_matter_to_env_for_estrajs",s=>{s.env.extrajsConf=(0,y.default)(s.src).data.extrajs??{}});let r=t.renderer.render;t.renderer.render=function(s,o,m){let i=m.extrajsConf??{},c={...T,...e,...i.disableMermaid?{useMermaid:!1}:{},...i.disableFontAwesome?{useFontAwesome:!1}:{},...i.disableUnoCSS?{useUnoCSS:!1}:{}};return r.call(this,s,o,m)+a(c,i)+p(c)}}var h=F;var k=h;
